...
ENDOGENOUS_VAR = "INGRESO_PC"
INSTRUMENT_VARS = ["NIVEL_EDUCATIVO"]
CLUSTER_VAR = "UBIGEO"
ENTITY_VAR = "UBIGEO"
COVARIATES = ["GENERO", "EDAD", "INTERNET_HOGAR", "SMARTPHONE", "FORMAL"]
PLACEBO_OUTCOMES = ["GASHOG2D"]
MEDIATOR_VAR = "FORMAL"
HETEROGENEITY_VARS = ["GENERO", "ESTRATO"]
