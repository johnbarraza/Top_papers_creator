...
RUNNING_VAR = "running_centered"          # always use centered version
CLUSTER_VAR = "{{CLUSTER_VAR}}"           # e.g., "kommun_id"
COVARIATES_BASIC = {{COVARIATES_BASIC}}   # e.g., ["Income", "Foreignborn", "College"]
COVARIATES_EXT = {{COVARIATES_EXT}}       # e.g., above + ["Age", "Unemployed31"]
EXPECTED_SIGNS = {{EXPECTED_SIGNS}}       # e.g., {"rightforeign": "+", "leftforeign": "?"}
