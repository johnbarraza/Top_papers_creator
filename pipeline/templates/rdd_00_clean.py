...
RUNNING_VAR = "{{RUNNING_VAR}}"           # e.g., "running" or "vote_margin"
THRESHOLD = {{THRESHOLD}}                 # e.g., 0 (if already centered) or a formula
TREATMENT_VAR = "{{TREATMENT_VAR}}"       # e.g., "entry" or constructed from running
OUTCOME_VARS = {{OUTCOME_VARS}}           # e.g., ["rightforeign", "leftforeign"]
CLUSTER_VAR = "{{CLUSTER_VAR}}"           # e.g., "kommun_id"
TIME_VAR = "{{TIME_VAR}}"                 # e.g., "year" or None
COVARIATES = {{COVARIATES}}               # e.g., ["Income", "College", "Age"]
PLACEBO_OUTCOMES = {{PLACEBO_OUTCOMES}}   # e.g., ["placebo_rightforeign"] or []
